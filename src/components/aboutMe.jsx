            ...
            <div className="container aboutMe">
                <div className='div1'>
                    ...
                    <div className='about'>
                        ...
                        <p>My name is [Your Name], and I am a front-end developer <br /> with a passion for building responsive and user-friendly web applications. <br /> I started my journey in IT in 2018 as a self-taught Python programmer and <br /> later pursued a degree in "Automated Systems and Control" at college, <br /> graduating in 2021. Afterward, I continued my education at university, <br /> completing a degree in "Internet Technologies and Management" in 2024. <br />
